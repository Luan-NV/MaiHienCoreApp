    ...
    function registerEvents() {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        maihien.notify('Update role successful', 'success');
                    ...
                    error: function () {
                        maihien.notify('Has an error', 'error');
                        maihien.stopLoading();
                    }
                });
                return false;
        ...
        $('body').on('click', '.btn-delete', function (e) {
            ...
            maihien.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    error: function (status) {
                        maihien.notify('Has an error in deleting progress', 'error');
                        maihien.stopLoading();
                    }
                });
            });
        ...
        $("#btnSavePermission").off('click').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    maihien.notify('Save permission successful', 'success');
                    $('#modal-grantpermission').modal('hide');
                    maihien.stopLoading();
                },
                error: function () {
                    maihien.notify('Has an error in save permission progress', 'error');
                    maihien.stopLoading();
                }
            });
        });
