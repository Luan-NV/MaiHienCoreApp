        ...
        $('body').on('click', '#btnDelete', function (e) {
            ...
            maihien.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    success: function (response) {
                        maihien.notify('Deleted success', 'success');
                        maihien.stopLoading();
                        loadData();
                    },
                    error: function (status) {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        maihien.notify('Update success', 'success');
                    ...
                    error: function () {
                        maihien.notify('Has an error in update progress', 'error');
                        maihien.stopLoading();
                    }
                });
            }
    ...
    function loadData() {
        $.ajax({
            ...
            success: function (response) {
                ...
                var treeArr = maihien.unflattern(data);
